class AppStrings {
  static String appName = "Smart Expense";
  ...
  static String walkThroughTitle3 = "Planing ahead";
  ...
  static String noteOptional = "Notes : Optional ";
  ...
  static String detailTransaction = "Transaction Detail";
  ...
  static String dataDeleteSuccess = ":data delete successfully!";
